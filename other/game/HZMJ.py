...
def test3Combine(mj1, mj2, mj3):
	t1, t2, t3 = mj1 / 9, mj2 / 9, mj3 / 9
	# 牌型不同不能组合
	if t1 != t2 or t1 != t3:
		return False
	v1, v2, v3 = mj1 % 9, mj2 % 9, mj3 % 9
	# 重牌
	if v1 == v2 and v1 == v3:
		return True
	if t3 == 4:
...
def getTingArr(mjArr, hunMj):
	...
	print("结果：%s" % str(jaNdHunArr))

	curHunNum = len(sptArr[0])
	print("将的数量：%s" % curHunNum)
	tingArr = []
	paiArr = [[0, 9], [9, 18], [18, 27], [31, 31]]
...
majmap = {"0": "一万", "1": "二万", "2": "三万", "3": "四万", "4": "五万", "5": "六万", "6": "七万", "7": "八万","8": "九万", "9": "一饼", "10": "二饼", "11": "三饼", "12": "四饼", "13": "五饼", "14": "六饼", "15": "七饼", "16": "八饼", "17": "九饼", "18": "一条", "19": "二条", "20": "三条", "21": "四条", "22": "五条", "23": "六条", "24": "七条", "25": "八条", "26": "九条", "27": "东风", "28": "西风", "29": "南风", "30": "北风", "31": "红中", "32": "发财", "33": "白板"}
...
if __name__ == "__main__":
	...
	##############################
	samArr = [0, 0, 0, 1, 2, 3, 4, 5, 6, 7, 7, 8, 8]
